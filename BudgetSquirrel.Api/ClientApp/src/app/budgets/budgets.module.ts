...
import { MatExpansionModule, MatFormFieldModule, MatInputModule, MatIconModule,
  MatButtonModule, MatCheckboxModule, MatBottomSheetModule } from "@angular/material";
...
import { EditMonthlybookendedDurationFormComponent }
  from "./duration/edit-monthlybookended-duration-form/edit-monthlybookended-duration-form.component";
...
@NgModule({
  declarations: [
    ...
    ConfirmAmountBottomSheetComponent
  ],
  imports: [
    CommonModule,
    FormsModule,
  ...
  entryComponents: [ConfirmAmountBottomSheetComponent],
  exports: [
    BudgetOverviewComponent,
    AddBudgetFormComponent,
    BudgetComponent
